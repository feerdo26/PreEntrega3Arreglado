...
if exist "%RADS_PATH%\Game" (
	...
	if exist "League of Legends.exe" (
		@start "" "League of Legends.exe" "spectator spectator-consumer.la2.lol.pvp.net:80 oK2JKvxV0VaX8fuOe7F99kro4FkfqtTJ 1331567886 LA2" "-UseRads" "-Locale=!locale!" "-GameBaseDir=.."
		goto :eof
	)
)
